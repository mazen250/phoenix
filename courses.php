<?php
  ...
  $rows= "SELECT * from courses";
  $result= mysqli_query($myDB, $rows);
  $arr= mysqli_fetch_all($result, MYSQLI_ASSOC);

  // courses per page
  $numArr=count($arr);
  $numPages=ceil($numArr/12);
  if(!isset($_GET['ID']) || $_GET['ID']==0){
    $id=1;
  }elseif($_GET['ID']> ceil(count($arr)/12)){
    $id=ceil(count($arr)/12);
  }else{
    $id=$_GET['ID'];
  }
  $start= ($id-1)*12;
  $sql= "SELECT * from courses LIMIT $start,12";
  ...
  <body>
    ...
    <header class="container" style="margin-bottom: 0 !important">
      <div class="container head" style="margin-bottom: 0 !important">
        <a href="index.html">
          <img
            src="images/phoenixacademy.png"
            alt="phoenixacademy logo"
            height="50"
          />
        </a>
        <div class="slogann">
    ...
    <nav
      class="container navbar navbar-dark navbar-expand-lg bg-dark sticky-top"
      ...
      <div class="container-fluid" style="flex-direction: row-reverse">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          >
            ...
            <li class="nav-item">
              <a class="nav-link active link-active" href="courses.php">Courses</a>
            </li>
            <li class="nav-item">
    ...
    <div class="courses">
        <div class="intro-courses">
            <h2>Our Courses</h2>
            <p>British Phoenix Academy accredit different courses, and Our certificates are rich your CV to apply in any companies local or international.</p>
            <p><?php echo($thisArr[0]['name']) ?></p>
        </div>
        <div class="programs">
            <?php
        ...
        <div class="pages">
            <?php
                if(ceil(count($arr)/12)>1){
                echo('
                <button class="page-link"><a href="courses.php?ID='.($id-1).'"><</button>
                <button class="page-link"><a href="courses.php?ID=1">1</a></button>');
                    for($i=2; $i<ceil(count($arr)/12); $i++){
                    echo('<button class="page-link"><a href="courses.php?ID='.$i.'">'.$i.'</a></button>');
                    }
                    echo('
                    <button class="page-link"><a href="courses.php?ID='.($id+1).'">></a></button>');
                } elseif(ceil(count($arr)/12)==1){
                echo('<button class="page-link" class="active"><a href="#">1</a></button>');
            }?>
        </div>
    </div>
          ...
          >
            <div class="footer-logo">
              <a class="footer-logo-link" href="#">
                ...
                <img src="./images/phoenixacademy.png" />
              </a>
            </div>
        ...
        <div class="footer-copyright">
          <div class="footer-copyright-wrapper">
            <p class="footer-copyright-text">
              <a class="footer-copyright-link" href="index.html">
                ©2022. | Developed By: Phoenix Web development team. | All
                rights reserved.
              </a>
            </p>
          </div>
